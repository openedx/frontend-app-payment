...
// TODO: clean commented code here
...
export default function handleRequestError(error) {
  ...
  if (error.response && error.response.data !== undefined) {
    logInfo('API Error', error.response.data);
    handleApiErrors([
      {
        error_code: error.response.data.error_message_id,
        user_message: error.response.data.error_message,
        message_type: 'error',
      },
    ]);
  }

  // TODO: ensure that we don't need the following handlers
  // // API errors
